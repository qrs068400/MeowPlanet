        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Sitter>(entity =>
            {
                ...
                entity.HasMany(d => d.Features)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        "SitterFeature",
                        l => l.HasOne<Feature>().WithMany().HasForeignKey("FeatureId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_sitter_feature_feature"),
                        r => r.HasOne<Sitter>().WithMany().HasForeignKey("ServiceId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_sitter_feature_sitter"),
                        j =>
                        {
                            j.HasKey("ServiceId", "FeatureId");

                            j.ToTable("sitter_feature");
